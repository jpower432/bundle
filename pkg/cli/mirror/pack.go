...
func (o *MirrorOptions) Pack(ctx context.Context, assocs image.AssociationSet, meta *v1alpha2.Metadata, archiveSize int64, pullBlobs bool) (storage.Backend, error) {
	...
	manifests, blobs, err := bundle.ReconcileV2Dir(meta.PastMirror.Association, paths)
	if err != nil {
